...
class CircularButton:
    ...
    def on_left_click(self, event):
        ...
        # Send Data
        table.putString("Number", self.number)
...
class HexagonApp:
    def __init__(self, root):
        ...
        # Reef image
        img = Image.open("C:/Users/Santy/Downloads/Captura de pantalla 2025-07-25 234126.png")
        ...
        for i in range(6):
            ...
            for fi, f in enumerate(fractions):
                ...
                l2Btn = self.create_circle_button(x1, y1, side, "L2", str(sideIndex))
                l3Btn = self.create_circle_button(x3, y3, side, "L3", str(sideIndex))
                l4Btn = self.create_circle_button(x2, y2, side, "L4", str(sideIndex))
